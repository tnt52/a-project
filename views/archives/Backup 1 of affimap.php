...
var m=$(keyM+"more<?=TMmem?>");
  if (m!=null) selMember(m.getPrevious(),"affimap");
       ...
       new Ajax(urlbase+'index.php/navigation/more/'+m.getProperty('cat')+'/'+keyM,{update: txtdiv,method: 'get', onComplete: function(){showM(m,txtdiv);}, evalScripts: true}).request();
  }
}
