...
<body bgcolor="#FFFFFF">
<DIV class="CatTitle membres" ALIGN=CENTER>Membres</DIV>
<DIV id="SearchM">
...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 STYLE='page-break-before: always; page-break-inside: avoid' align='left'>
     ...
     <TD >
         ...
         <?=lang("head_pseudo")?> <img class="tri desc" rang="" src="<?=base_url()?>/system/application/images/spacer.gif" />
         </DIV>
     </TD>
     <TD >
         <DIV champ="sexe"  style="cursor:pointer" onclick="tri(this)" onmouseover="hoverTri(this)" onmouseout="unhoverTri(this)">
         <?=lang("head_sexe")?> <img class="tri desc" rang="" src="<?=base_url()?>/system/application/images/spacer.gif" />
         </DIV>
     </TD>
     <TD >
         <DIV champ="voix"  style="cursor:pointer" onclick="tri(this)" onmouseover="hoverTri(this)" onmouseout="unhoverTri(this)">
         <?=lang("head_voix")?> <img class="tri desc" rang="" src="<?=base_url()?>/system/application/images/spacer.gif" />
         </DIV>
     </TD>
     <TD >
         <DIV champ="affinite"  style="cursor:pointer" onclick="tri(this)" onmouseover="hoverTri(this)" onmouseout="unhoverTri(this)">
         <?=lang("head_affinite")?> <img class="tri desc" rang="" src="<?=base_url()?>/system/application/images/spacer.gif" />
         </DIV>
     </TD>
     </TR>
</TABLE>
