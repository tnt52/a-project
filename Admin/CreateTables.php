...
`pseudo` VARCHAR (".size_pseudo.") NOT NULL,
...
`link` VARCHAR(50),
`textearti` TEXT,
`nom` VARCHAR (".size_nom.") NOT NULL,
`imageart` VARCHAR (50),
`typesart` VARCHAR(30),
`autretype` VARCHAR(25),
`datecrea` TIMESTAMP DEFAULT 00000000000000,
`datemodif` TIMESTAMP DEFAULT 00000000000000,
`datelastupdate` TIMESTAMP DEFAULT 00000000000000,
